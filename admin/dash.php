...
$participants=$participant1C->recupererparticipants();
?>
<!doctype html>
<html lang="en">
        ...
        <ul class="nav">
          ...
          <li class="nav-item active  ">
            <a class="nav-link" href="ajouter.php">
              <i class="material-icons">Ajouter Animateur</i>
              <p>Animateur</p>
            </a>
          </li>
          <!-- your sidebar here -->
          ...
          <table id="myTable" >
                                        <thead>
                                            <tr class="row100 head">
                                                ...
                                                <th class="cell100 column1">Imprimer</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                    ...
                                    <tr class="row100 head">
                                        ...
                                        <td class="cell100 column1"><?php echo $row["date"] ; ?></td>
                                        <td class="cell100 column1"><?php echo $row["sexe"] ; ?></td>
                                        <td class="cell100 column1"><?php echo $row["email"] ; ?></td>
                                        <td class="cell100 column1"><?php echo $row["telephone"] ; ?></td>
                                        <td class="cell100 column1"><?php echo $row["adresse"] ; ?></td>
                                        <td class="cell100 column1"><a href="modifierparticipant.php?id=<?PHP echo $row['id']; ?>">Modifier</a></td>
                                        <td>
                            ...
                            <td>   
                                              <form method="POST" action="imprimer.php">
                                                    <input type="submit" name="imprimer" value="imprimer" > </input>
